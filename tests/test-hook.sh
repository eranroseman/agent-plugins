...
[ "$(jq -r '.version' "$PLUGIN/.claude-plugin/plugin.json")" = '0.5.2' ] || fail "Claude manifest version must be 0.5.2"
[ "$(jq -r '.version' "$PLUGIN/.codex-plugin/plugin.json")" = '0.5.2' ] || fail "Codex manifest version must be 0.5.2"
