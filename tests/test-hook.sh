...
[ "$(jq -r '.version' "$PLUGIN/.claude-plugin/plugin.json")" = '0.5.0' ] || fail "Claude manifest version must be 0.5.0"
[ "$(jq -r '.version' "$PLUGIN/.codex-plugin/plugin.json")" = '0.5.0' ] || fail "Codex manifest version must be 0.5.0"
