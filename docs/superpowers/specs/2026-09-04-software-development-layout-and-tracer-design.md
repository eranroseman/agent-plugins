...
| 2 | Setup and materialisation **merged with 4 on 2026-09-05**: own setup skill (not `setup-matt-pocock-skills`, which is repo-level and does not overlap), cutover automation, the mattpocock adoption route, the pinned clone and Codex symlinks, environment variables, the five `harness-backup` files as templates, **plus everything that was sub-project 4**. Design: [2026-09-05-setup-and-drift-design.md](2026-09-05-setup-and-drift-design.md) | 1 | #62 and #63, #78, #95, including the five live-tree findings |
