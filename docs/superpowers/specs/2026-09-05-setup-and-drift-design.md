...
| Worktree cleanup, Claude | **Delete after the cutover, not before.** It already ships in `hooks/working-rules.md`, but the installed plugin is still 0.1.0, so the file is currently the only carrier.                                                                                                                                                                                                                                                                                                                                                                         |
