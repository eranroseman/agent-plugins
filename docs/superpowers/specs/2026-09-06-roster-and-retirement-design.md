...
**One audited instance supports it**, in [docs/adr/2026-08-25-coding-companion-plugins-comparison.md](../../adr/2026-08-25-coding-companion-plugins-comparison.md) — adopted into this repository on 2026-09-06 precisely so this claim does not rest on a private document that may move. It records, of this repository's own work: *"the run's most expensive error class … maps onto its Phase-1 red-capable-loop criterion; systematic-debugging has no equivalent."*
